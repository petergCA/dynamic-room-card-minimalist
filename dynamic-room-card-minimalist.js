    ...
    Uo = function (t) {
      ...
      return function (t, e) {
        ...
        function (t, e, o) {
          ...
          key: "_calcRows",
          value: function (e) {
            return Math.max(2, Math.ceil(Math.max(84, 2 + 54 * e) / 56))
          }
        }, {
          key: "getCardSize",
          value: function () {
            ...
            var e = this._config.entities ? this._config.entities.length : 0,
              ...
              r = Math.max(Math.ceil(e / n), Number(this._config.entity_rows) || 0);
            return this._calcRows(r)
          }
        }, {
          key: "getGridOptions",
          value: function () {
            ...
            var e = this._config.entities ? this._config.entities.length : 0,
              ...
              n = Math.max(Math.ceil(e / o), Number(this._config.entity_rows) || 0),
              i = this._calcRows(n);
            return {
              columns: 12,
              min_columns: 12,
